...
Postmate.Model = class Model {
  ...
  constructor(model) {
    ...
    this.childApi = new ChildAPI(this)
  }
  ...
  _shake(e) {
    ...
    if (e.data.postmate === 'handshake') {
      ...
      this.child.removeEventListener('message', this._shake, false)
      if (process.env.NODE_ENV !== 'production') {
   ...
   */
  sendHandshakeReply() {
    this.child.addEventListener('message', this._shake.bind(this), false)
  }
}
